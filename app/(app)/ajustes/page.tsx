  ...
  return (
    <div className="space-y-5 max-w-2xl">
      <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
        <h3 className="text-gray-900 font-semibold text-sm">Datos de la empresa</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
        <h3 className="text-gray-900 font-semibold text-sm">Datos bancarios</h3>
        <div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
        <h3 className="text-gray-900 font-semibold text-sm">Configuración de facturación</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5 space-y-4">
        <h3 className="text-gray-900 font-semibold text-sm">Temporada</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div>
            ...
            {users.map(u => {
              ...
              return (
                <div key={u.id} className="flex items-center gap-4 px-5 py-4">
                  <div className="w-9 h-9 rounded-full bg-gray-200 flex items-center justify-center text-[#C9A84C] font-bold text-sm flex-shrink-0">
  ...
  return (
    <div className="space-y-4">
          ...
          <div key={u.id} className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            <div className="p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
              {ALL_PERMISSIONS.map(p => {
                ...
                return (
                  <div key={p.key} className={`rounded-lg border transition-all ${has ? 'border-[#C9A84C]/40 bg-[#C9A84C]/5' : 'border-gray-200'}`}>
                    {/* Fila acceso */}
                    <button onClick={() => {
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        <h3 className="text-gray-900 font-semibold text-sm mb-3">Referencia de roles</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {ROLES.map(r => (
