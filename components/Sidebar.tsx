...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    // Use saved permissions if any, otherwise fall back to role defaults
  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col bg-[#0A0A0A] border-r border-[#2A2A2A]">
      {/* Logo */}
      <div className="px-4 py-4 border-b border-[#2A2A2A] flex items-center justify-center">
        <img src="/logo.jpg" alt="Black Boats Ibiza" className="h-24 w-auto object-contain" />
      </div>
      ...
      <div className="px-3 pb-3 border-t border-[#2A2A2A] pt-2">
        ...
        <p className="text-[#444] text-xs text-center mt-2">Black Boats © 2025</p>
      </div>
    </aside>
  )
}
